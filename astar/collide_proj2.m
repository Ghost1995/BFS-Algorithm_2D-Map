%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This code checks for collision with an obstacle for project 2. It also
% ensures that the point is inside the map.
% 
% Input:
%      map --> Description of the map
%   points --> Points to be checked for collision
% 
% Output:
%         C --> Status of collision for the given points
%   gridPos --> Position of the last point in the map (grid)
% 
% Submitted by: Ashwin Goyal (UID - 115526297)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [C,varargout] = collide_proj2(map, points)
